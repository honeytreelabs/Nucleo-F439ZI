...
# core flags
set(CORE_FLAGS "-mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=hard --specs=nosys.specs ${ADDITIONAL_CORE_FLAGS}")

# compiler: language specific flags
set(CMAKE_C_FLAGS "${CORE_FLAGS} -Wall -std=gnu99 -fdata-sections -ffunction-sections" CACHE INTERNAL "c compiler flags")
set(CMAKE_C_FLAGS_DEBUG "-O0 -g3 -gdwarf-2" CACHE INTERNAL "c compiler flags: Debug")
set(CMAKE_C_FLAGS_RELEASE "-Os" CACHE INTERNAL "c compiler flags: Release")

set(CMAKE_CXX_FLAGS "${CORE_FLAGS} -Wall -std=gnu++17 -fdata-sections -ffunction-sections" CACHE INTERNAL "cxx compiler flags")
...
set(CMAKE_ASM_FLAGS_DEBUG "-O0 -g -gdwarf-2" CACHE INTERNAL "asm compiler flags: Debug")
